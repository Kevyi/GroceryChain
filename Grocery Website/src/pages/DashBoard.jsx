...
export default function DashboardPage() {
  ...
  const [isAuthorized, setIsAuthorized] = useState(null); // State to track admin authorization
  ...
  // Fetch data only if admin is authorized
  useEffect(() => {
    if (isAuthorized) {
      fetchProductData();
      fetchPopularItems();
  ...
  if (isAuthorized === null) {
    return <div>Loading...</div>; // Show a loading indicator while verifying access
  }
      ...
      <section className={styles.section}>
        ...
        <div className={styles.chartWrapper}>
          {popularItems.length > 0 ? (
            ...
            <p className={styles.noPopularItemsMessage}>No purchases recorded yet.</p>
          )}
        </div>
      </section>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.tableWrapper}>
          {lowStockItems.length > 0 ? (
            ...
            <p className={styles.lowStockMessage}>All items are sufficiently stocked!</p>
          )}
        </div>
      </section>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.tableWrapper}>
          {outOfStockItems.length > 0 ? (
            ...
            <p className={styles.outOfStockMessage}>No items are currently out of stock!</p>
          )}
        </div>
      </section>
    </div>
